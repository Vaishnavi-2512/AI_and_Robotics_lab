...
const admins = [
  { loginId: "A0001", email: "venkatesh@eee.sastra.edu", password: "admin1", name: "T. Venkatesh" },
  { loginId: "A0002", email: "126179012@sastra.ac.in", password: "admin2", name: "Karthikeya" },
  { loginId: "A0003", email: "126179030@sastra.ac.in", password: "admin3", name: "Vaishnavi" },
];
...
async function seedAdmins() {
  for (const a of admins) {
    try {
      ...
      // 4) loginLookup mapping
      await db.doc(`loginLookup/${a.loginId}`).set({ email: a.email, uid });
